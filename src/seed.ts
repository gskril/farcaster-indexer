...
//   formatVerifications,
// } from './lib/utils.js'
// import { MergeMessageHubEvent } from './types.js'
...
//   )._unsafeUnwrap()
//   // const signersResponse = (await client.getOnChainSignersByFid(fid))._unsafeUnwrap()
...
//  */
// function hubMessageToJSON(messages: Message[]) {
//   return messages.map((message) => {
//     const json = Message.toJSON(message) as MergeMessageHubEvent
